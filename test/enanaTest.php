...
class EnanaTest extends TestCase {
    ...
    public function testHeridaLeveVive() {
        ...
        $this->assertEquals("viva",$objeto->heridaLeve(10));
    ...
    public function testHeridaGrave() {
        ...
        $this->assertEquals("viva",$objeto->heridaGrave(0));
    ...
    public function testPocimaRevive() {
        ...
        $this->assertEquals("muerta",$objeto->pocima(-2));
    ...
    public function testPocimaExtraLimbo() {
        ...
        $this->assertEquals("limbo",$objeto->pocimaExtra(0));
