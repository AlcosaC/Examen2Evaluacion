...
class EnanaTest extends TestCase {
    ...
    public function testHeridaLeveVive() {
        ...
        $this->assertEquals("viva",$objeto->heridaLeve(10),"Laura");
    ...
    public function testHeridaLeveMuere() {
        ...
        $this->assertEquals($objeto->heridaLeve(10));
    ...
    public function testHeridaGrave() {
        ...
        $this->assertEquals($objeto->heridaGrave(0));
    ...
    public function testPocimaRevive() {
        $objeto = new Enana("Estefania","-5","muerta");
        $this->assertEquals($objeto->pocima(-2));
    ...
    public function testPocimaExtraLimbo() {
        ...
        $this->assertEquals($objeto->pocimaExtra(0));
